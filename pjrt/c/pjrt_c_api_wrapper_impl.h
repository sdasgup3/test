...
#include "third_party/tensorflow/compiler/xla/pjrt/c/pjrt_c_api_memory_descriptions_extension.h"
...
struct PJRT_PartialProgram {
  ...
  size_t program_size;
  size_t format;
  char* generating_phase;
  const char** next_phases;
  size_t num_next_phases;
  char* version;
};
