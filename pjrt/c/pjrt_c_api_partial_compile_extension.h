...
#ifndef TENSORFLOW_COMPILER_XLA_PJRT_C_PJRT_C_API_PARTIAL_COMPILE_EXTENSION_H_
#define TENSORFLOW_COMPILER_XLA_PJRT_C_PJRT_C_API_PARTIAL_COMPILE_EXTENSION_H_
...
struct PJRT_PartialCompile_Run_Phase_Args {
  size_t struct_size;
...
PJRT_DEFINE_STRUCT_TRAITS(PJRT_PartialCompile_Run_Phase_Args, num_programs_out);

typedef PJRT_Error* PJRT_PartialCompile_Run_Phase(
    PJRT_PartialCompile_Run_Phase_Args* args);

// Used to retrieve the names of all registered partial compilation phases.
struct PJRT_PartialCompile_Get_PhaseNames_Args {
  size_t struct_size;
  PJRT_Extension_Base* extension_start;
  const char** phase_names;
  size_t num_phases;
};
PJRT_DEFINE_STRUCT_TRAITS(PJRT_PartialCompile_Get_PhaseNames_Args, num_phases);
typedef PJRT_Error* PJRT_PartialCompile_Get_PhaseNames(
    PJRT_PartialCompile_Get_PhaseNames_Args* args);

// --------------------------- Extension entrypoint ----------------------------

// The main struct for the PJRT Partial Compile Extension.
typedef struct PJRT_PartialCompile_Extension {
  PJRT_Extension_Base base;
  PJRT_PartialCompile_Run_Phase* partial_compile_run_phase;
  PJRT_PartialCompile_Get_PhaseNames* partial_compile_get_phase_names;
} PJRT_PartialCompile_Extension;

PJRT_DEFINE_STRUCT_TRAITS(PJRT_PartialCompile_Extension,
...
#endif  // TENSORFLOW_COMPILER_XLA_PJRT_C_PJRT_C_API_PARTIAL_COMPILE_EXTENSION_H_
